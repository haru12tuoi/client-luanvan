...
// const Intro = () => {
//   return (
//     <div className='border border-red-500 w-3/5 bg-white rounded-md shadow-md p-4 '>
//       <h3 className='font-semibold text-lg flex justify-center items-center '>{text.title}</h3>
