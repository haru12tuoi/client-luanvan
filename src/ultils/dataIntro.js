export const text = {
    title: 'Tại sao lại chọn HoangPhuc.com?',
    description: 'Chúng tôi biết bạn có rất nhiều lựa chọn, nhưng HoangPhuc.com tự hào là trang web đứng top google về các từ khóa: ',
    ...
    comment: '"Trước khi biết website HoangPhuc, mình phải tốn nhiều công sức và chi phí cho việc đăng tin cho thuê: từ việc phát tờ rơi, dán giấy, và đăng lên các website khác nhưng hiệu quả không cao. Từ khi biết website HoangPhuc.com, mình đã thử đăng tin lên và đánh giá hiệu quả khá cao trong khi chi phí khá thấp, không còn tình trạng phòng trống kéo dài."',
